locals {
  ...
  env_vars = {
    ...
    MONGO_USER    = data.aws_caller_identity.this.id == "000000000000" ? null : element(aws_docdb_cluster.this.*.master_username, 0)
    MONGO_PASS    = data.aws_caller_identity.this.id == "000000000000" ? null : element(aws_docdb_cluster.this.*.master_password, 0)
